...
export default function EnrollmentForm({ course }: { course: Course }) {
  ...
  // If user has filled the form, show the Payment/QR screen
  if (showPayment) {
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all font-medium"
            value={formData.name}
